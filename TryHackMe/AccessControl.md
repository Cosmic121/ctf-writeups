...
**How I found it:**
Robots.txt is used by developers to tell website crawlers the websites that doesn't needs to be indexed. However, robots.txt was publically available which inturn exposed "administrator_panel".
